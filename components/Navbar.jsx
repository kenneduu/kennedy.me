...
const Navbar = () => {
  ...
  return (
    <div className="w-full h20 z-10 fixed bg-white 
    text-black duration-300 easein">

        <div className="flex justify-between items-center w-full h-full
        max-w-screen-xl mx-auto p-4">
            <Link href='/#home'>
              <h1 className="text-3xl lg:text-4xl font-bold
              uppercase underline underline-offset-2 tracking-wider cursor-pointer">
                 Kennedy </h1>
            </Link>
...
<div
      ...
      >
        <div
          className={
            navigation
              ? "fixed left-0 top-0 w-4/5 h-full bg-gradient-to-r from-slate-500 to-slate-400 text-white p-10 ease-in duration-500"
        ...
        >
                ...
                <div>
                      <div className="flex w-full items-center justify-between">
                        <Link href='#home'> 
                        <h2 className="text-3xl font-bold uppercase underline underline-offset-2
